...
<p class="lesson-p">תוכלו להתחיל לבנות את סוכן ה GEM בעצמכם, או כדי להתחיל לבנות את סוכן ה GEM שלכם, הכנסו לקישור הבא. הסוכן שיצרנו יעביר אתכם, שלב אחרי שלב בנוסחא, על מנת לבנות את הסוכן המוצלח ביותר עבורכם</p>
