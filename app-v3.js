...
<p class="lesson-p">בניגוד לשיחה רגילה שבה התשובות נעלמות במעלה הצ'אט, Gemini Canvas פותח מסך עבודה ייעודי מפוצל (Split-screen) לצד השיחה. הקנבס בונה קוד ליצירת תוצרים רבים:
...
<ol style="margin-right: 20px; margin-bottom: 15px; line-height: 1.6;">
    ...
    <li style="margin-bottom: 8px;"><strong>שלב 2: ניסוח פרומפט לבניית המוצר שבחרתם ליצור:</strong> היעזרו בג'מיני על מנת לנסח את הפרומפט (ניתן להוסיף קבצים, תמונות ואפילו מחברות Notebook). יפתח מסך מפוצל – חלק ימני לשיחה וחלק שמאלי יציג את המוצר שיצרתם.</li>
