...
<p class="lesson-p">בניגוד לשיחה רגילה שבה התשובות נעלמות במעלה הצ'אט, Gemini Canvas פותח מסך עבודה ייעודי מפוצל (Split-screen) לצד השיחה. הקנבס בונה קוד ליצירת תוצרים רבים, ממש כאילו היית מתכנת אמיתי מבלי הצורך לדעת שפות קוד או ניסיון קודם בתכנות: 
